...
var routingComponents = [_home_page_home_page_component__WEBPACK_IMPORTED_MODULE_3__["HomePageComponent"]];
...
var HomePageComponent = /** @class */ (function () {
    function HomePageComponent(http, routeService, route) {
        this.http = http;
        this.routeService = routeService;
        this.route = route;
        this.items = [];
    }
    HomePageComponent.prototype.getNames = function () {
        this.url = '/Names';
        return this.http.get(this.url);
    };
    HomePageComponent.prototype.getDetails = function () {
        var _this = this;
        this.route.queryParams.subscribe(function (params) {
            console.log(params);
            _this.nameId = params['nameId'];
            console.log(_this.nameId);
        });
        this.url = '/Name?nameId=' + this.nameId;
        return this.http.get(this.url);
    };
    HomePageComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.getNames().subscribe(function (data) { return (_this.items = data); });
        this.getDetails().subscribe(function (data) { return (_this.item = data); });
    };
...
module.exports = __webpack_require__(/*! C:\Users\meetb\Desktop\Balaji\angularProject\Jenkins\src\main.ts */"./src/main.ts");
